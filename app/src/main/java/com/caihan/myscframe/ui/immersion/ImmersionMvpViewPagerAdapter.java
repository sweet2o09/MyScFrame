 ...
 * 维护者
 */
public class ImmersionMvpViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public ImmersionMvpViewPagerAdapter(Context context, FragmentManager fm) {
        super(fm);
        ...
        switch (position) {
            case PAGER_0:
                if (!mFragmentMap.containsKey(PAGER_0)) {
                    fragment = ImmersionMvpFragment.newInstance(1);
            ...
            case PAGER_1:
                if (!mFragmentMap.containsKey(PAGER_1)) {
                    fragment = ImmersionMvpFragment.newInstance(2);
            ...
            case PAGER_2:
                if (!mFragmentMap.containsKey(PAGER_2)) {
                    fragment = ImmersionMvpFragment.newInstance(3);
            ...
            case PAGER_3:
                if (!mFragmentMap.containsKey(PAGER_3)) {
                    fragment = ImmersionMvpFragment.newInstance(4);
            ...
            case PAGER_4:
                if (!mFragmentMap.containsKey(PAGER_4)) {
                    fragment = ImmersionMvpFragment.newInstance(5);

...
import com.caihan.myscframe.ui.immersion.ImmersionMvpFragment;
 ...
 * 维护者
 */
public class MultilayerActViewPagerAdapter extends FragmentPagerAdapter {
    ...
    private final static int PAGER_3 = 3;
    private final static int PAGER_4 = 4;

    private HashMap<Integer, BaseFragment> mFragmentMap = new HashMap<>();
    private Context mContext;

    public MultilayerActViewPagerAdapter(Context context, FragmentManager fm) {
        super(fm);
        ...
        switch (position) {
            case PAGER_0:
                if (!mFragmentMap.containsKey(PAGER_0)) {
                    fragment = MultilayerMvpFragment.newInstance(1);
            ...
            case PAGER_1:
                if (!mFragmentMap.containsKey(PAGER_1)) {
                    fragment = MultilayerMvpFragment.newInstance(2);
            ...
            case PAGER_2:
                if (!mFragmentMap.containsKey(PAGER_2)) {
                    fragment = MultilayerMvpFragment.newInstance(3);
            ...
            case PAGER_3:
                if (!mFragmentMap.containsKey(PAGER_3)) {
                    fragment = MultilayerMvpFragment.newInstance(4);
            ...
            case PAGER_4:
                if (!mFragmentMap.containsKey(PAGER_4)) {
                    fragment = MultilayerMvpFragment.newInstance(5);

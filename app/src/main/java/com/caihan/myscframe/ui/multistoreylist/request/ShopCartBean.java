...
public class ShopCartBean {
    ...
    private List<CartActivityItemBean> cartActivityItemList;//购物车商品活动分类
    ...
    public List<CartActivityItemBean> getCartActivityItemList() {
        return cartActivityItemList;
    }

    public void setCartActivityItemList(List<CartActivityItemBean> cartActivityItemList) {
        this.cartActivityItemList = cartActivityItemList;
    }
}

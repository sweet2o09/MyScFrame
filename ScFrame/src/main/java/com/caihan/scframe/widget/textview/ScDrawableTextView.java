...
public class ScDrawableTextView extends TextView {
    ...
    public ScDrawableTextView(Context context) {
        this(context, null);
    }

    public ScDrawableTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public ScDrawableTextView(Context context, AttributeSet attrs, int defStyleAttr) {

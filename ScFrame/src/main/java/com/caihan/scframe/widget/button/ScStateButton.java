 ...
 */
public class ScStateButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        mNormalTextColor = a.getColor(R.styleable.ScStateButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.ScStateButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.ScStateButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();
        ...
        mNormalBackgroundColor = a.getColor(R.styleable.ScStateButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.ScStateButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.ScStateButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.ScStateButton_radius, 0);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.ScStateButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.ScStateButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.ScStateButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.ScStateButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.ScStateButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.ScStateButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.ScStateButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.ScStateButton_unableStrokeColor, 0);
        setStroke();

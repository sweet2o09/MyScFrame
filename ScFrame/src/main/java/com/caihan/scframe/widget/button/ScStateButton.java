package com.caihan.scframe.widget.button;
...
public class ScStateButton extends Button {
    ...
    public ScStateButton(Context context) {
        this(context, null);
    }

    public ScStateButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public ScStateButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ScStateButton);

        //get original text color as default
        //set text color
        mTextColorStateList = getTextColors();
        int mDefaultNormalTextColor = mTextColorStateList.getColorForState(
                states[2], getCurrentTextColor());
        int mDefaultPressedTextColor = mTextColorStateList.getColorForState(
                states[0], getCurrentTextColor());
        int mDefaultUnableTextColor = mTextColorStateList.getColorForState(
                states[3], getCurrentTextColor());
        mNormalTextColor = a.getColor(R.styleable.ScStateButton_normalTextColor,
                mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.ScStateButton_pressedTextColor,
                mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.ScStateButton_unableTextColor,
                mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.ScStateButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(
                R.styleable.ScStateButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(
                R.styleable.ScStateButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(
                R.styleable.ScStateButton_unableBackgroundColor, 0);
        ...
        mRadius = a.getDimensionPixelSize(
                R.styleable.ScStateButton_radius, 0);
        mRound = a.getBoolean(R.styleable.ScStateButton_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(
                R.styleable.ScStateButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(
                R.styleable.ScStateButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(
                R.styleable.ScStateButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(
                R.styleable.ScStateButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(
                R.styleable.ScStateButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(
                R.styleable.ScStateButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(
                R.styleable.ScStateButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(
                R.styleable.ScStateButton_unableStrokeColor, 0);
        setStroke();
    ...
    public void setStateStrokeColor(@ColorInt int normal,
                                    @ColorInt int pressed, @ColorInt int unable) {
    ...
    public void setStateBackgroundColor(@ColorInt int normal,
                                        @ColorInt int pressed, @ColorInt int unable) {
    ...
    private void setTextColor() {
        int[] colors = new int[]{mPressedTextColor, mPressedTextColor,
                mNormalTextColor, mUnableTextColor};
        mTextColorStateList = new ColorStateList(states, colors);
        setTextColor(mTextColorStateList);
    }

    public void setStateTextColor(@ColorInt int normal,
                                  @ColorInt int pressed, @ColorInt int unable) {

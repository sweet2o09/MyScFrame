 ...
 * 备注：
 */
public class ScWaveView extends View {
    /**
     * +------------------------+
     * |<--wave length->        |______
     * |   /\          |   /\   |  |
    ...
    public ScWaveView(Context context) {
        super(context);
        init();
    }

    public ScWaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ScWaveView(Context context, AttributeSet attrs, int defStyle) {

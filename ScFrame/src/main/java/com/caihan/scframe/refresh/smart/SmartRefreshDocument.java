...
class SmartRefreshDocument {
    ...
    RefreshLayout setRefreshLayout(Context context, RefreshLayout refreshLayout) {
        ...
        refreshLayout.setEnableFooterFollowWhenNoMoreData(false);//设置是否在没有更多数据之后 Footer 跟随内容
        ...
        refreshLayout.setScrollBoundaryDecider(new ScrollBoundaryDeciderAdapter());//设置滚动边界判断

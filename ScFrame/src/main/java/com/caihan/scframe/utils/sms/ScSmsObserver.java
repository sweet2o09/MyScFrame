package com.caihan.scframe.utils.sms;
 ...
 */
public class ScSmsObserver extends ContentObserver {
    ...
    public ScSmsObserver(Activity activity, Handler handler, String like, SmsListener listener) {
        super(handler);
    ...
    public void onChange(boolean selfChange) {
        ...
        if (cursor != null) {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (EmptyUtils.isNotEmpty(smsContent)) {

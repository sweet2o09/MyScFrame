package com.caihan.scframe.utils.network;
...
public class ScNetworkUtils {
     ...
     * @return 网络类型
     * <ul>
     * <li>{@link ScNetworkUtils.NetworkType#NETWORK_WIFI   } </li>
     * <li>{@link ScNetworkUtils.NetworkType#NETWORK_4G     } </li>
     * <li>{@link ScNetworkUtils.NetworkType#NETWORK_3G     } </li>
     * <li>{@link ScNetworkUtils.NetworkType#NETWORK_2G     } </li>
     * <li>{@link ScNetworkUtils.NetworkType#NETWORK_UNKNOWN} </li>
     * <li>{@link ScNetworkUtils.NetworkType#NETWORK_NO     } </li>
     * </ul>
     */

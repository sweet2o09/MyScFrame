 ...
 * 此类主要是用来放一些系统过时方法的处理
 */
public class ScOutdatedUtil {

    private ScOutdatedUtil() {
    ...
    public static Drawable getDrawable(@DrawableRes int id) {
        return ContextCompat.getDrawable(ScFrame.getContext(), id);
    }
    ...
    public static Drawable getDrawable(@DrawableRes int id,
        ...
        return ResourcesCompat.getDrawable(ScFrame.getResources(), id, theme);
    }
    ...
    public static int getColor(@ColorRes int id) {
        return ContextCompat.getColor(ScFrame.getContext(), id);
    }
    ...
    public static int getColor(@ColorRes int id, @Nullable Resources.Theme theme) {
        return ResourcesCompat.getColor(ScFrame.getResources(), id, theme);
    }
    ...
    public static ColorStateList getColorStateList(@ColorRes int id) {
        return ContextCompat.getColorStateList(ScFrame.getContext(), id);
    }
